...
class SpiderMath(CrawlSpider,BaseObject):
    ...
    def __init__(self):
        ...
        self.cookie = {'xd': 'f2e51c682b7972ee79c3e5e278111819a2a875abde801b145946725928925c52a%3A2%3A%7Bi%3A0%3Bs%3A2%3A%22xd%22%3Bi%3A1%3Bi%3A2%3B%7D',
                       '_csrf': '2128f3fca9fee877e89c3e0dbb8a3497d60d1763661dbfa2e22b3aa3d5dc8794a%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22zToRUt8Dw8xQtenNh9Rj6k5J3Tgsw51Q%22%3B%7D',
                       'chid': '91ab0098f41dadc79a63b6bf560dd5c255a7c8c4203ca602dd1302827ff0ed9da%3A2%3A%7Bi%3A0%3Bs%3A4%3A%22chid%22%3Bi%3A1%3Bs%3A1%3A%226%22%3B%7D',
                       'Hm_lvt_5d70f3704df08b4bfedf4a7c4fb415ef': '1516006558',
                       'Hm_lpvt_5d70f3704df08b4bfedf4a7c4fb415ef': '1516006583'}
        ...
        #                '_csrf': 'b99d92586ef60a352350fbc246db115e5bf19ebb32de6980249f4b484eea9493a%3A2%3A%7Bi%3A0%3Bs%3A5%3A%22_csrf%22%3Bi%3A1%3Bs%3A32%3A%22Dul0_4DE3d4N-mykqxPDu95L_NxPobnq%22%3B%7D',
        #                'Hm_lvt_5d70f3704df08b4bfedf4a7c4fb415ef': '1515738493,1515738647,1515738704,1515982417',
        #                'xd': '053c08991644b3be1f1cce76412b1634d2eb9867b529f5e7d3129bc291581e9ba%3A2%3A%7Bi%3A0%3Bs%3A2%3A%22xd%22%3Bi%3A1%3Bs%3A1%3A%222%22%3B%7D',
        #                'chid': '91ab0098f41dadc79a63b6bf560dd5c255a7c8c4203ca602dd1302827ff0ed9da%3A2%3A%7Bi%3A0%3Bs%3A4%3A%22chid%22%3Bi%3A1%3Bs%3A1%3A%226%22%3B%7D',
        #                'Hm_lpvt_5d70f3704df08b4bfedf4a7c4fb415ef': '1516004435'}
        self.heaeder = {
        ...
        if (totle > 0):
            if (pages > 3):
                ...
                for perPages in range(1, pages):
                    timeStamp = int(time.time()) * 1000
                    start_url = 'https://zujuan.21cnjy.com/question/list?categories={0}&question_channel_type={1}&difficult_index=&exam_type=&kid_num=&grade_id%5B%5D=0&grade_id%5B%5D=7&grade_id%5B%5D=8&grade_id%5B%5D=9&sortField=time&filterquestion=0&page={2}&page={2}&_={3}'.format(
                        response.meta['zhangjieNumber'], response.meta['question_type_index'], str(perPages),
                        str(timeStamp))
                    yield Request(url=start_url, meta=response.meta, cookies=self.cookie, headers=self.heaeder,
                                  callback=self.param_question)
