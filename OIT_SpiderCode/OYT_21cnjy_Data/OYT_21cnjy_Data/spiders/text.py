...
#
#         }
#         self.Parampath = "D:\\21cnjy\\{0}\\categories_param\\".format(time.strftime('%Y%m%d',time.localtime()))
...
#         main_url = 'https://zujuan.21cnjy.com/question/detail/5492193'
#         return [Request(url=main_url,headers = self.heaeder,callback=self.parse_detail,cookies=self.cookie)]
