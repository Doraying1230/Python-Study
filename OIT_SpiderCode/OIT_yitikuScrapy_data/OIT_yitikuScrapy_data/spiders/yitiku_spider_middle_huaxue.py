...
#                 pa = 'D:\\xiti10001\\Special123Picture\\{}\\'.format(time.strftime('%Y%m%d', time.localtime()))
#
#             if isEixct:
#                 pass
#             else:
