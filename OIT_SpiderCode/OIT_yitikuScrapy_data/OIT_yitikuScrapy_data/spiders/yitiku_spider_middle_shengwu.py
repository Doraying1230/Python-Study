...
#     name = "yitiku_middle_shengwu_data"
#
#     def __init__(self):
#         ua = UserAgent()
#         user_agent = ua.random
#         self.cookie = {'pgv_pvi': '2939488256', '_qddaz': 'QD.uom73t.v505ck.jcsu33ab', 'tencentSig': '5878706176', 'PHPSESSID': 'qkab7dqsgda80hrtdddtrbr7a7', 'pgv_si': 's8624628736', 'IESESSION': 'alive', 'Hm_lvt_ba430f404e1018c19017fd7d6857af83': '1516784091,1516872355', '_qdda': '3-1.1', '_qddab': '3-502gfj.jcuamw46', '_qddamta_800024201': '3-0', 'jiami_userid': 'Njk0MjM4fDlkMmM0ZWZlNjI5ZDVhNjFjZjIzYTk4Y2Q3M2UzNDYx', 'account': '15921276816', 'password': 'MTIzNDU2', 'ytkuser': '%7B%22id%22%3A%22694238%22%2C%22deadline%22%3A%220%22%2C%22feature%22%3A%221f67de767e055612dc9845720250d778%22%7D', '_qddac': '3-1.1.502gfj.jcuamw46', 'Hm_lpvt_ba430f404e1018c19017fd7d6857af83': '1516873591'}
#         self.headers = {
...
#                                 yield Request(url=requestUrl, meta=response.meta, headers=self.headers, cookies=self.cookie,
#                                               callback=self.param_detail)
#                         else:
