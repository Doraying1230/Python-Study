...
#     name = "yitiku_middle_english_data"
#
#     def __init__(self):
#         ua = UserAgent()
...
#
#         }
#         self.cookie = {'pgv_pvi': '8869029888', 'tencentSig': '8349357056', 'PHPSESSID': '21rbna3k500ic89ga8qjmqhjs3',
...
#             'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.62 Safari/537.36'
#         }
#         self.diffultDegree = {'1.00-0.86': '容易', '0.85-0.71': '较易', '0.70-0.56': '中等', '0.55-0.41': '较难','0.40-0.26': '困难'}
...
#                                     if len(perAllComment) == 0:
#                                         totle_zhangjie = perXueQiParamDict['zhnagjie_text_url']
#                                         reUrl = totle_zhangjie[perzhangjie]
#                                         requestUrl = self.main_url + reUrl
#                                         perXueQiParamDict['currentSection'] = perzhangjie
#                                         perXueQiParamDict['currentSmallSection'] = 'None'
#                                         perXueQiParamDict['main_url'] = requestUrl
#                                         yield Request(url=requestUrl, headers=self.headers, meta=perXueQiParamDict,callback=self.param_detail)
#                                     else:
