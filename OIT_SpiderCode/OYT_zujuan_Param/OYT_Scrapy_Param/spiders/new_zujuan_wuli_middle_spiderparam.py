...
class ZuQuanLoadData(BaseObject,CrawlSpider):
    ...
    def __init__(self):
        ...
        self.file_name='zujuan_wuli_middle_param'
    ...
    def start_requests(self):
        start_url = 'http://www.zujuan.com/question/index?chid=6&xd=2'
    ...
    def parse_categories_content(self,response):
        ...
        with open('d:\\xiti10001\\zujuan\\{0}\\{1}\\categories_wuli_{0}.txt'.format(time.strftime('%Y%m%d',time.localtime(time.time())),self.file_name),'a') as f:
