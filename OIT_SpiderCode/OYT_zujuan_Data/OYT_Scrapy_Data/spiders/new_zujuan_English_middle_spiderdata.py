...
#     name = 'zujuan_english_middle_data'
#     custom_settings = {
...
#         self.filename = 'zujuan_english_middle_data'
...
#
#     def start_requests(self):
#         with open('d:\\xiti10001\\zujuan\\{0}\\zujuan_english_middle_param\\categories_english_{0}.txt'.format(time.strftime('%Y%m%d',time.localtime(time.time())))) as f:
#             needStr = f.read()
