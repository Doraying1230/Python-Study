...
#         self.filename = 'zujuan_math_middle_data'
...
#
#     def start_requests(self):
#         with open('d:\\xiti10001\\zujuan\\{0}\\zujuan_math_middle_param\\categories_math_{0}.txt'.format(time.strftime('%Y%m%d',time.localtime(time.time())))) as f:
#             needStr = f.read()
